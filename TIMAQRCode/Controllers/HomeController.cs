...
namespace TIMAQRCode.Controllers
{
    ...
    public static class BitmapExtension
    {
        ...
        public static async Task<Bitmap> GenerateQRCodeWithLogoAndFooter(string data, string logoRelativePath, string headerPath, string footerRelativePath, string footerLogoRelativePath, int qrSize = 250, int logoSizePercentage = 20, int footerSizePercentage = 20)
        {
